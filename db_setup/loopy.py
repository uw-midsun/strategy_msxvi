...
import math
from routemodel import init_table
from routemodel import insert_data

load_dotenv()

def gpx_parser():
    """
    Parse GPX loopy files to extract essential route data and save it to a structured array
    ...
    # Open gpx file and parse the file
